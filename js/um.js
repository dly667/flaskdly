...
function(e) {
    ...
    t(0)
        ...
        d || (s.umx = f, s.um = f),
        s.pointman && s.pointman.define("um",
        function() {
            return d ? s.umx: f
        })
    }).call(t,
...
function(e, t) {
    ...
    n.prototype = {
        ...
        then: function(e, t) {
            ...
            o = r(i, e, "resolve"),
            a = r(i, t, "reject");
            return this._state === s ? o(this._value) : this._state === l ? a(this._reason) : (this._onFulfilled.push(o), this._onRejected.push(a)),
            i
        },
        resolve: function(e) {
            this._state === c && (this._state = s, this._value = e, u(this._onFulfilled,
            function(t) {
                t(e)
            }), this._onFulfilled = [])
        },
        reject: function(e) {
            this._state === c && (this._state = l, this._reason = e, u(this._onRejected,
            function(t) {
                t(e)
            }), this._onRejected = [])
        },
...
function(e, t) {
    ...
    a = function(e, t) {
        ...
        var n = r[e];
        if (n) if (t) for (var i = n.length - 1; i >= 0; i--) n[i] === t && n.splice(i, 1);
        else delete r[e]
    },
    u = function(e) {
        var t = r[e],
        ...
        if (t) {
            t = t.slice();
            for (var o = 0,
            a = t.length; o < a; o++) t[o].apply(null, i)
        }
    };
    e.exports = {
        on: i,
...
function(e, t, n) { (function(t) {
        ...
        d = function(e, t, n) {
            if (e) {
                var r = 0,
                i = e.length;
                if (i === +i) for (; r < i && t.call(n, e[r], r, e) !== !1; r++);
        ...
        p = {
            ...
            post: function(e, t, n) {
                ...
                var i = new u(function(n, r) {
                    ...
                    i.open(o, e, !0),
                    i.withCredentials = !0,
                    i.setRequestHeader && i.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"),
                    i.onload = a,
                    i.onerror = u,
                    i.send("data=" + encodeURIComponent(t))
                });
            ...
            groupHash: function(e) {
                ...
                d(e,
                function(e) {
                    var n = e.charAt(0).toUpperCase(); (n < "A" || n > "Z") && (n = "zh"),
                    t[n] = t[n] || [],
                    t[n].push(e)
                });
                var n = [];
    ...
    function() {
        ...
        function str(e, t) {
            ...
            case "object":
                ...
                if (rep && "object" == typeof rep) for (o = rep.length, n = 0; n < o; n += 1)"string" == typeof rep[n] && (r = rep[n], i = str(r, c), i && a.push(quote(r) + (gap ? ": ": ":") + i));
                else for (r in c) Object.prototype.hasOwnProperty.call(c, r) && (i = str(r, c), i && a.push(quote(r) + (gap ? ": ": ":") + i));
                return i = 0 === a.length ? "{}": gap ? "{\n" + gap + a.join(",\n" + gap) + "\n" + u + "}": "{" + a.join(",") + "}",
                gap = u,
                i
            }
...
function(e, t) {
    ...
    n.hash = function(e, t) {
        ...
        c = Math.ceil(u / 16),
        s = new Array(c);
        for (i = 0; i < c; i++) for (s[i] = new Array(16), a = 0; a < 16; a++) s[i][a] = e.charCodeAt(64 * i + 4 * a) << 24 | e.charCodeAt(64 * i + 4 * a + 1) << 16 | e.charCodeAt(64 * i + 4 * a + 2) << 8 | e.charCodeAt(64 * i + 4 * a + 3);
        ...
        C = new Array(80);
        for (i = 0; i < c; i++) {
            for (o = 0; o < 16; o++) C[o] = s[i][o];
            for (o = 16; o < 80; o++) C[o] = n.ROTL(C[o - 3] ^ C[o - 8] ^ C[o - 14] ^ C[o - 16], 1);
            for (l = m, f = g, d = v, p = T, h = S, o = 0; o < 80; o++) {
                var y = Math.floor(o / 20),
                B = n.ROTL(l, 5) + n.f(y, f, d, p) + h + r[y] + C[o] & 4294967295;
                h = p,
                p = d,
                d = n.ROTL(f, 30),
                f = l,
...
function(e, t, n) { (function(t) {
        ...
        function o(e, t) {
            ...
            for (n = 0; n < i.length; n++) if ("um_token" == i[n].getAttribute("name")) {
                r = i[n];
                break
            }
            return r ? r.value = t: (r = m.createElement("input"), r.type = "hidden", r.name = "um_token", r.value = t, e.appendChild(r)),
            r
        }
        var a = n(7),
        u = n(8),
        ...
        g.prototype = {
            ...
            send: function() {
                ...
                s.post(t.serviceUrl, i, t.jsonp).then(function(n) {
                    ...
                    e.defer.resolve(n),
                    a.set(d.storeTimeKey, new Date - e.startTime),
...
function(e, t) {
    ...
    r = function(e) {
        if (!e) return "";
        for (var t, r, i, o, a, u, c, s = "",
        l = 0; l < e.length;) t = e.charCodeAt(l++),
        r = e.charCodeAt(l++),
        i = e.charCodeAt(l++),
        o = t >> 2,
        a = (3 & t) << 4 | r >> 4,
...
function(e, t) {
    ...
    e.exports = {
        get: function(e) {
            var t, n;
            return o(e) && (n = String(document.cookie).match(new RegExp("(?:^| )" + e + "(?:(?:=([^;]*))|;|$)"))) && (t = n[1] ? i(n[1]) : ""),
            t
        },
        set: function(e, t, i, a, u, c) {
            var s = String(r(t)),
            l = a;
            return "number" == typeof l && (l = new Date, l.setTime(l.getTime() + a * n)),
...
function(e, t, n) {
    ...
    e.exports = {
        set: function(e, t) {
            ...
            o.set(e, t),
            e === a.storeKey && u ? i.set("um", t, u[1], 365, "/") : i.set(e, t, null, 365, "/")
        },
        get: function(e) {
            var t, n = {
                name: e
...
function(e, t, n) { (function(t) {
        ...
        m = h.support,
        g = d.each,
        v = (d.extend, d.singleton),
        T = d.groupHash,
        S = t,
        C = S.document,
        y = S.navigator,
        B = "https://local.alipcsec.com:6691/umid/getumid",
        M = {
            type: function() {
                return "pc"
            },
            nce: function() {
                return y.cookieEnabled
            },
            plat: function() {
                var e = y.platform;
            ...
            saw: function() {
                return S.screen.availWidth
            },
            sah: function() {
                return S.screen.availHeight
            },
            bsw: function() {
                return C.body && C.body.clientWidth
            },
            bsh: function() {
                return C.body && C.body.clientHeight
            },
            eloc: function() {
            ...
            ms: function() {
                return l.get(p.storeTimeKey)
            },
            erd: function() {
                var e = a.defer();
                return y.mediaDevices && y.mediaDevices.enumerateDevices ? navigator.mediaDevices.enumerateDevices().then(function(t) {
            ...
            cacheid: function() {
                ...
                n.src = "https://ynuf.alipay.com/uid",
        ...
        M.xh = function(e) {
            if (o()) return "";
            var t = "";
            return d.jsonp(B, "").then(function(e) {
                return t = e && 0 === e.error ? e.umid_token: "ERR:" + e.error
            })["catch"](function(e) {
                return ""
            })
        };
        ...
        var x = function() {
            ...
            var o = {},
            a = {};
            for (var u in e) i.style.fontFamily = e[u],
            r.appendChild(i),
            o[e[u]] = i.offsetWidth,
            a[e[u]] = i.offsetHeight,
            r.removeChild(i);
            var c = function(t) {
                var n = !1;
                for (var u in e) {
                    i.style.fontFamily = t + "," + e[u],
                    r.appendChild(i);
        ...
        M.jsfonts = function(e) {
            if (m.CORS && e.enableJSFonts) {
                var t = x(),
                n = {
                    jfonts: u.hash(t.join(",")),
                    efcn: t.length,
                    efts: T(t),
                    efty: 1
                };
        ...
        var w = function() {
            var e = 0;
            return m.plugin ? !!y.plugins["Silverlight Plug-In"] : m.ActiveXObject ? !!new ActiveXObject("AgControl.AgControl") : e
        },
        A = function() {
            var e = [];
            return g(y.plugins || [],
        ...
        k = function() {
            ...
            },
            {
                ...
                getVersion: function(e, t) {
                    for (var n = "1",
                    r = "0",
                    i = "0"; e.IsVersionSupported(n + "." + r + "." + i);) n++;
        ...
        M.plugin = function() {
            if (m.CORS) {
                var e = [];
                return m.plugin ? e = A() : m.ActiveXObject && (e = k()),
                {
                    epl: e.length,
                    ep: u.hash(e.join(",")),
                    epls: T(e),
        ...
        e.exports = {
            init: function(e, t) {
                ...
                function(r, i) {
                    try {
                        var o = r(e, t);
                        "undefined" == typeof o ? n[i] = a.reject() : d.isObject(o) ? o instanceof a ? n[i] = o: o.promise instanceof a ? (setTimeout(function() {
                            o.reject(i + ": timeout")
                        },
                        3e3), n[i] = o.promise) : n[i] = a.resolve(o) : n[i] = a.resolve(o)
                    } catch(u) {}
                }),
                n
            }
...
function(e, t, n) {
    ...
    function i() {
        for (var e, t = c.getElementsByTagName("script"), n = /security\/umscript/, r = 0; r < t.length; r++) if (e = o(t[r]), n.test(e)) return t[r];
